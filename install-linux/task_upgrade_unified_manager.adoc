...
[role="lead"]
Você pode atualizar do Unified Manager 9,10 ou 9,11 para 9,12 baixando e executando o arquivo de instalação na plataforma Linux.
...
* O MySQL Community Edition é atualizado automaticamente durante a atualização do Unified Manager. Se a versão instalada do MySQL no seu sistema for anterior à 8,0.30, o processo de atualização do Unified Manager atualizará automaticamente o MySQL para 8,0.30.
