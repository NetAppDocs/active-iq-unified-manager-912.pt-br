...
Todos os objetos na página
 a| 
A image:../media/select_dropdown_65_png.gif[""]caixa suspensa e escolha *Selecione todos os objetos nesta página*.
...
Todos os objetos do mesmo tipo
 a| 
A image:../media/select_dropdown_65_png.gif[""]caixa suspensa e escolha *Selecionar todos os objetos*.
